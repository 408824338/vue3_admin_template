...
<template>
  <el-card>
    <!-- 调试信息 -->
    <el-form :inline="true">
      <el-form-item label="一级分类" :disabled="scene === 0 ? false : true">
        <el-select v-model="categoryStore.c1Id" @change="handler" placeholder="请选择一级分类" class="harf_width">
      ...
      <el-form-item label="二级分类" :disabled="scene === 0 ? false : true">
        <el-select v-model="categoryStore.c2Id" @change="hander1" placeholder="请选择二级分类" class="harf_width">
          <el-option v-for="(c2,index) in categoryStore.c2Arr" :key="c2.id" :label="c2.name" :value="c2.id"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="三级分类" :disabled="scene === 0 ? false : true">
        <el-select v-model="categoryStore.c3Id" placeholder="请选择三级分类" class="harf_width">
...
<style scoped>
.harf_width{width: 200px!important;}
</style>